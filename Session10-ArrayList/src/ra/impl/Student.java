...
public class Student implements IStudent{
    ...
    @Override
    public void inputData(Scanner scanner, List<Student> listStudent) {
        ...
        do {
            ...
            for (int i = 0; i < listStudent.size(); i++) {
                if (listStudent.get(i).studentId.equals(this.studentId)){
                    isExit= true;
                    break;
                }
            }
    ...
    public void displayData() {
        ...
        System.out.printf("HTML: %.1f - CSS: %.1f - Javascript: %.1f - Avg Mark: %.1f - Xếp loại: %s - Trạng thái: %s\n", this.htmlScore, this.cssScore, this.javascriptScore, this.avgMark, this.rank, this.status);
    }
